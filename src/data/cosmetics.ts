...
> = {
  ...
  goldmine: {
    background: '#1A1209',  // Dark mine brown
    lines: '#F59E0B',       // Gold
    ball: '#FFD700',        // Bright gold
    text: '#F59E0B',        // Gold text
...
> = {
  ...
  mine: {
    background: '#1A1209',  // Dark mine shaft
    surface: '#2D261A',     // Dark stone surface
    lines: '#F59E0B',       // Gold ore veins
    accent: '#8B4513',      // Brown rock accent
  },
};
